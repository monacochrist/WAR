...
ctx_lua = {
    ...
    VK_MAX_FRAMES                       = 1,
    VK_GLYPH_COUNT                      = 128,
    VK_NSGT_BIN_CAPACITY                = 1024,  -- fixed for tight-frame condition
    VK_NSGT_FRAME_CAPACITY              = 512,   -- fixed for tight-frame condition
    VK_NSGT_FREQUENCY_MIN               = 20,    -- fixed for tight-frame condition
    VK_NSGT_FREQUENCY_MAX               = 20000, -- fixed for tight-frame condition
    VK_NSGT_ALPHA                       = 1.0,
    VK_NSGT_WINDOW_LENGTH_MIN           = 32,
    VK_NSGT_SHAPE_FACTOR                = 6.0,
    -- compute
    VK_NSGT_COMPUTE_RESOURCE_COUNT      = 26,
    -- visual
...
pool_wr = {
    ...
    { name = "ctx_nsgt.memory_property_flags",         type = "VkMemoryPropertyFlags",        count = ctx_lua.VK_NSGT_COMPUTE_RESOURCE_COUNT },
    { name = "ctx_nsgt.usage_flags",                   type = "VkBufferUsageFlags",           count = ctx_lua.VK_NSGT_COMPUTE_RESOURCE_COUNT },
    { name = "ctx_nsgt.buffer",                        type = "VkBuffer",                     count = ctx_lua.VK_NSGT_COMPUTE_RESOURCE_COUNT },
    { name = "ctx_nsgt.memory_requirements",           type = "VkMemoryRequirements",         count = ctx_lua.VK_NSGT_COMPUTE_RESOURCE_COUNT },
    { name = "ctx_nsgt.device_memory",                 type = "VkDeviceMemory",               count = ctx_lua.VK_NSGT_COMPUTE_RESOURCE_COUNT },
    { name = "ctx_nsgt.map",                           type = "void*",                        count = ctx_lua.VK_NSGT_COMPUTE_RESOURCE_COUNT },
    { name = "ctx_nsgt.capacity",                      type = "VkDeviceSize",                 count = ctx_lua.VK_NSGT_COMPUTE_RESOURCE_COUNT },
    { name = "ctx_nsgt.descriptor_buffer_info",        type = "VkDescriptorBufferInfo",       count = ctx_lua.VK_NSGT_COMPUTE_RESOURCE_COUNT },
    { name = "ctx_nsgt.descriptor_image_info",         type = "VkDescriptorImageInfo",        count = ctx_lua.VK_NSGT_COMPUTE_RESOURCE_COUNT },
    { name = "ctx_nsgt.image",                         type = "VkImage",                      count = ctx_lua.VK_NSGT_COMPUTE_RESOURCE_COUNT },
    { name = "ctx_nsgt.image_view",                    type = "VkImageView",                  count = ctx_lua.VK_NSGT_COMPUTE_RESOURCE_COUNT },
    { name = "ctx_nsgt.format",                        type = "VkFormat",                     count = ctx_lua.VK_NSGT_COMPUTE_RESOURCE_COUNT },
    { name = "ctx_nsgt.extent_3d",                     type = "VkExtent3D",                   count = ctx_lua.VK_NSGT_COMPUTE_RESOURCE_COUNT },
    { name = "ctx_nsgt.image_usage_flags",             type = "VkImageUsageFlags",            count = ctx_lua.VK_NSGT_COMPUTE_RESOURCE_COUNT },
    { name = "ctx_nsgt.shader_stage_flags",            type = "VkShaderStageFlags",           count = ctx_lua.VK_NSGT_COMPUTE_RESOURCE_COUNT },
    { name = "ctx_nsgt.descriptor_set_layout_binding", type = "VkDescriptorSetLayoutBinding", count = ctx_lua.VK_NSGT_COMPUTE_RESOURCE_COUNT },
    { name = "ctx_nsgt.write_descriptor_set",          type = "VkWriteDescriptorSet",         count = ctx_lua.VK_NSGT_COMPUTE_RESOURCE_COUNT },
    { name = "ctx_nsgt.mapped_memory_range",           type = "VkMappedMemoryRange",          count = ctx_lua.VK_NSGT_COMPUTE_RESOURCE_COUNT },
    { name = "ctx_nsgt.buffer_memory_barrier",         type = "VkBufferMemoryBarrier",        count = ctx_lua.VK_NSGT_COMPUTE_RESOURCE_COUNT },
    { name = "ctx_nsgt.image_memory_barrier",          type = "VkImageMemoryBarrier",         count = ctx_lua.VK_NSGT_COMPUTE_RESOURCE_COUNT },
    -- env
