...
ctx_lua = {
    ...
    VK_NSGT_COMPUTE_BUFFER_COUNT        = 10,
    VK_NSGT_VISUAL_BUFFER_COUNT         = 2,
    -- misc
...
pool_wr = {
    ...
    -- nsgt compute context
    { name = "ctx_nsgt_compute",                               type = "war_vulkan_nsgt_compute_context", count = 1 },
    { name = "ctx_nsgt_compute.memory_property_flags",         type = "VkMemoryPropertyFlags",           count = ctx_lua.VK_NSGT_COMPUTE_BUFFER_COUNT },
    { name = "ctx_nsgt_compute.usage_flags",                   type = "VkBufferUsageFlags",              count = ctx_lua.VK_NSGT_COMPUTE_BUFFER_COUNT },
    { name = "ctx_nsgt_compute.buffer",                        type = "VkBuffer",                        count = ctx_lua.VK_NSGT_COMPUTE_BUFFER_COUNT },
    { name = "ctx_nsgt_compute.memory_requirements",           type = "VkMemoryRequirements",            count = ctx_lua.VK_NSGT_COMPUTE_BUFFER_COUNT },
    { name = "ctx_nsgt_compute.device_memory",                 type = "VkDeviceMemory",                  count = ctx_lua.VK_NSGT_COMPUTE_BUFFER_COUNT },
    { name = "ctx_nsgt_compute.map",                           type = "void*",                           count = ctx_lua.VK_NSGT_COMPUTE_BUFFER_COUNT },
    { name = "ctx_nsgt_compute.capacity",                      type = "VkDeviceSize",                    count = ctx_lua.VK_NSGT_COMPUTE_BUFFER_COUNT },
    { name = "ctx_nsgt_compute.descriptor_buffer_info",        type = "VkDescriptorBufferInfo",          count = ctx_lua.VK_NSGT_COMPUTE_BUFFER_COUNT },
    { name = "ctx_nsgt_compute.shader_stage_flags",            type = "VkShaderStageFlags",              count = ctx_lua.VK_NSGT_COMPUTE_BUFFER_COUNT },
    { name = "ctx_nsgt_compute.descriptor_set_layout_binding", type = "VkDescriptorSetLayoutBinding",    count = ctx_lua.VK_NSGT_COMPUTE_BUFFER_COUNT },
    { name = "ctx_nsgt_compute.write_descriptor_set",          type = "VkWriteDescriptorSet",            count = ctx_lua.VK_NSGT_COMPUTE_BUFFER_COUNT },
    -- nsgt visual context
    { name = "ctx_nsgt_visual",                                type = "war_vulkan_nsgt_visual_context",  count = 1 },
    { name = "ctx_nsgt_visual.memory_property_flags",          type = "VkMemoryPropertyFlags",           count = ctx_lua.VK_NSGT_VISUAL_BUFFER_COUNT },
    { name = "ctx_nsgt_visual.usage_flags",                    type = "VkBufferUsageFlags",              count = ctx_lua.VK_NSGT_VISUAL_BUFFER_COUNT },
    { name = "ctx_nsgt_visual.buffer",                         type = "VkBuffer",                        count = ctx_lua.VK_NSGT_VISUAL_BUFFER_COUNT },
    { name = "ctx_nsgt_visual.memory_requirements",            type = "VkMemoryRequirements",            count = ctx_lua.VK_NSGT_VISUAL_BUFFER_COUNT },
    { name = "ctx_nsgt_visual.device_memory",                  type = "VkDeviceMemory",                  count = ctx_lua.VK_NSGT_VISUAL_BUFFER_COUNT },
    { name = "ctx_nsgt_visual.map",                            type = "void*",                           count = ctx_lua.VK_NSGT_VISUAL_BUFFER_COUNT },
    { name = "ctx_nsgt_visual.capacity",                       type = "VkDeviceSize",                    count = ctx_lua.VK_NSGT_VISUAL_BUFFER_COUNT },
    -- env
