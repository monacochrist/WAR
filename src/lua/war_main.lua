...
ctx_lua = {
    ...
    VK_MAX_FRAMES                       = 1,
    VK_GLYPH_COUNT                      = 128,
    VK_SPECTROGRAM_WIDTH                = 512,
    VK_SPECTROGRAM_HEIGHT               = 256,
    -- misc
...
pool_wr = {
    ...
    { name = "spectrogram_vertices",                      type = "war_spectrogram_vertex", count = ctx_lua.WR_SPECTROGRAM_QUADS_MAX },
    { name = "spectrogram_indices",                       type = "uint16_t",               count = ctx_lua.WR_SPECTROGRAM_QUADS_MAX },
    -- note quads
