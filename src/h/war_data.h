...
#define WAR_PREVIEW_VOICES 16
    ...
    float play_bar_voice_filter_lp[WAR_PLAY_BAR_VOICES][4]; // [v][0]=lp_l, [1]=lp_r, [2]=smoothed_alpha, [3]=smoothed_t
    ...
    float preview_voice_filter_lp[WAR_PREVIEW_VOICES][4]; // [v][0]=lp_l, [1]=lp_r, [2]=smoothed_alpha, [3]=smoothed_t
