...
static inline void war_pool_set(war_pool_context* pool,
                                ...
                                uint64_t size,
                                uint64_t alignment) {
    if (pool->count >= pool->max_allocations) {
...
static inline void war_pool_default(war_pool_context* pool,
    ...
    //-------------------------------------------------------------------------
    war_pool_set(
        pool, WAR_POOL_ID_AUDIO_CTX_PW, sizeof(war_pipewire_context) * (1), 32);
    war_pool_set(pool,
    ...
    war_pool_set(pool,
                 ...
                 32);
    war_pool_set(
        pool, WAR_POOL_ID_AUDIO_PLAY_READ_COUNT, sizeof(uint64_t) * (1), 32);
    war_pool_set(pool,
                 WAR_POOL_ID_AUDIO_PLAY_LAST_READ_TIME,
                 sizeof(uint64_t) * (1),
                 32);
    war_pool_set(
        pool, WAR_POOL_ID_AUDIO_CAPTURE_READ_COUNT, sizeof(uint64_t) * (1), 32);
    war_pool_set(pool,
    ...
    // ctx hud
    war_pool_set(
        pool, WAR_POOL_ID_MAIN_CTX_HUD, sizeof(war_hud_context) * (1), 32);
    war_pool_set(pool,
    ...
    // ctx line
    war_pool_set(
        pool, WAR_POOL_ID_MAIN_CTX_LINE, sizeof(war_line_context) * (1), 32);
    war_pool_set(pool,
    ...
    // ctx text
    war_pool_set(
        pool, WAR_POOL_ID_MAIN_CTX_TEXT, sizeof(war_text_context) * (1), 32);
    war_pool_set(pool,
    ...
    // misc context
    war_pool_set(
        pool, WAR_POOL_ID_MAIN_CTX_MISC, sizeof(war_misc_context) * (1), 32);
    // nsgt context
    war_pool_set(
        pool, WAR_POOL_ID_MAIN_CTX_NSGT, sizeof(war_nsgt_context) * (1), 32);
    war_pool_set(pool,
    ...
    war_pool_set(pool,
                 ...
                 32);
    // env
    war_pool_set(pool, WAR_POOL_ID_MAIN_ENV, sizeof(war_env) * (1), 32);
    // command context
    war_pool_set(pool,
    ...
    // play context
    war_pool_set(
        pool, WAR_POOL_ID_MAIN_CTX_PLAY, sizeof(war_play_context) * (1), 32);
    war_pool_set(pool,
    ...
    // capture_wav
    war_pool_set(
        pool, WAR_POOL_ID_MAIN_CAPTURE_WAV, sizeof(war_file) * (1), 32);
    war_pool_set(pool,
    ...
    // color
    war_pool_set(
        pool, WAR_POOL_ID_MAIN_CTX_COLOR, sizeof(war_color_context) * (1), 32);
    // layres
    war_pool_set(pool,
    ...
    // FSM CONTEXT
    war_pool_set(
        pool, WAR_POOL_ID_MAIN_CTX_FSM, sizeof(war_fsm_context) * (1), 32);
    war_pool_set(pool,
    ...
    // ctx config
    war_pool_set(
        pool, WAR_POOL_ID_SHARED_CTX_CONFIG, sizeof(war_config_context), 32);
    // ctx keymap
    war_pool_set(
        pool, WAR_POOL_ID_MAIN_CTX_KEYMAP, sizeof(war_keymap_context), 32);
    war_pool_set(pool,
