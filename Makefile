...
SPECTROGRAM_VERT_SHADER_SRC := $(SHADER_SRC_DIR)/war_spectrogram_vertex.glsl
SPECTROGRAM_FRAG_SHADER_SRC := $(SHADER_SRC_DIR)/war_spectrogram_fragment.glsl
SPECTROGRAM_VERT_SHADER_SPV := $(SHADER_BUILD_DIR)/war_spectrogram_vertex.spv
SPECTROGRAM_FRAG_SHADER_SPV := $(SHADER_BUILD_DIR)/war_spectrogram_fragment.spv
...
all: $(BUILD_KEYMAP_FUNCTIONS_H) $(SPECTROGRAM_VERT_SHADER_SPV) $(SPECTROGRAM_FRAG_SHADER_SPV) \
$(QUAD_VERT_SHADER_SPV) $(QUAD_FRAG_SHADER_SPV) $(TEXT_VERT_SHADER_SPV) $(TEXT_FRAG_SHADER_SPV) $(TARGET)
...
$(SPECTROGRAM_VERT_SHADER_SPV): $(SPECTROGRAM_VERT_SHADER_SRC) | $(SHADER_BUILD_DIR)
	$(Q)$(GLSLC) -V -S vert $< -o $@

$(SPECTROGRAM_FRAG_SHADER_SPV): $(SPECTROGRAM_FRAG_SHADER_SRC) | $(SHADER_BUILD_DIR)
	$(Q)$(GLSLC) -V -S frag $< -o $@
...
$(TARGET): $(UNITY_O) $(BUILD_KEYMAP_FUNCTIONS_H) $(SPECTROGRAM_VERT_SHADER_SPV) $(SPECTROGRAM_FRAG_SHADER_SPV) $(QUAD_VERT_SHADER_SPV) $(QUAD_FRAG_SHADER_SPV) $(TEXT_VERT_SHADER_SPV) $(TEXT_FRAG_SHADER_SPV)
