...
NEW_VULKAN_VERTEX_PIANO_GUTTER_SHADER_SRC := $(SHADER_SRC_DIR)/war_new_vulkan_vertex_piano_gutter.glsl
NEW_VULKAN_VERTEX_PIANO_GUTTER_SHADER_SPV := $(SHADER_BUILD_DIR)/war_new_vulkan_vertex_piano_gutter.spv
NEW_VULKAN_FRAGMENT_PIANO_GUTTER_SHADER_SRC := $(SHADER_SRC_DIR)/war_new_vulkan_fragment_piano_gutter.glsl
NEW_VULKAN_FRAGMENT_PIANO_GUTTER_SHADER_SPV := $(SHADER_BUILD_DIR)/war_new_vulkan_fragment_piano_gutter.spv
NEW_VULKAN_VERTEX_GRIDLINES_SHADER_SRC := $(SHADER_SRC_DIR)/war_new_vulkan_vertex_gridlines.glsl
NEW_VULKAN_VERTEX_GRIDLINES_SHADER_SPV := $(SHADER_BUILD_DIR)/war_new_vulkan_vertex_gridlines.spv
NEW_VULKAN_FRAGMENT_GRIDLINES_SHADER_SRC := $(SHADER_SRC_DIR)/war_new_vulkan_fragment_gridlines.glsl
NEW_VULKAN_FRAGMENT_GRIDLINES_SHADER_SPV := $(SHADER_BUILD_DIR)/war_new_vulkan_fragment_gridlines.spv
...
SPV_BUILD_FILES := \
	...
	$(NEW_VULKAN_VERTEX_PIANO_GUTTER_SHADER_SPV) \
	$(NEW_VULKAN_FRAGMENT_PIANO_GUTTER_SHADER_SPV) \
	$(NEW_VULKAN_VERTEX_GRIDLINES_SHADER_SPV) \
	$(NEW_VULKAN_FRAGMENT_GRIDLINES_SHADER_SPV) \
...
$(NEW_VULKAN_VERTEX_HUD_TEXT_SHADER_SPV): $(NEW_VULKAN_VERTEX_HUD_TEXT_SHADER_SRC) | $(SHADER_BUILD_DIR)
	$(Q)$(GLSLC) -V -S vert $< -o $@
$(NEW_VULKAN_VERTEX_PIANO_GUTTER_SHADER_SPV): $(NEW_VULKAN_VERTEX_PIANO_GUTTER_SHADER_SRC) | $(SHADER_BUILD_DIR)
	$(Q)$(GLSLC) -V -S vert $< -o $@
$(NEW_VULKAN_FRAGMENT_PIANO_GUTTER_SHADER_SPV): $(NEW_VULKAN_FRAGMENT_PIANO_GUTTER_SHADER_SRC) | $(SHADER_BUILD_DIR)
	$(Q)$(GLSLC) -V -S frag $< -o $@
$(NEW_VULKAN_VERTEX_GRIDLINES_SHADER_SPV): $(NEW_VULKAN_VERTEX_GRIDLINES_SHADER_SRC) | $(SHADER_BUILD_DIR)
	$(Q)$(GLSLC) -V -S vert $< -o $@
$(NEW_VULKAN_FRAGMENT_GRIDLINES_SHADER_SPV): $(NEW_VULKAN_FRAGMENT_GRIDLINES_SHADER_SRC) | $(SHADER_BUILD_DIR)
	$(Q)$(GLSLC) -V -S frag $< -o $@
