...
NSGT_COMPUTE_SHADER_SRC := $(SHADER_SRC_DIR)/war_nsgt_compute.glsl
NSGT_COMPUTE_SHADER_SPV := $(SHADER_BUILD_DIR)/war_nsgt_compute.spv
...
all: $(BUILD_KEYMAP_FUNCTIONS_H) $(NSGT_COMPUTE_SHADER_SPV) $(NSGT_VERT_SHADER_SPV) $(NSGT_FRAG_SHADER_SPV) \
...
$(NSGT_COMPUTE_SHADER_SPV): $(NSGT_COMPUTE_SHADER_SRC) | $(SHADER_BUILD_DIR)
	$(Q)$(GLSLC) -V -S comp $< -o $@
...
$(TARGET): $(UNITY_O) $(BUILD_KEYMAP_FUNCTIONS_H) $(NSGT_COMPUTE_SHADER_SPV) $(NSGT_VERT_SHADER_SPV) $(NSGT_FRAG_SHADER_SPV) $(QUAD_VERT_SHADER_SPV) $(QUAD_FRAG_SHADER_SPV) $(TEXT_VERT_SHADER_SPV) $(TEXT_FRAG_SHADER_SPV)
